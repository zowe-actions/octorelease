...
var require_escape_string_regexp2 = __commonJS({
  "../../node_modules/@babel/code-frame/node_modules/escape-string-regexp/index.js"(exports, module2) {
    "use strict";
    var matchOperatorsRe = /[|\\{}()[\]^$+*?.]/g;
    module2.exports = function(str) {
      if (typeof str !== "string") {
...
var require_isexe = __commonJS({
  "../../node_modules/isexe/index.js"(exports, module2) {
    ...
    function isexe(path4, options, cb) {
      ...
      core4(path4, options || {}, function(er, is) {
        if (er) {
...
function shouldSkipStage(stage) {
  if (stage.canSkip !== false && Inputs.skipStages.includes(stage.name)) {
    core3.info(`Skipping "${stage.name}" stage`);
    return true;
  }
  return false;
}
