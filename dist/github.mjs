...
// packages/github/node_modules/semver/semver.js
var require_semver = __commonJS({
  "packages/github/node_modules/semver/semver.js"(exports, module) {
...
// packages/github/src/init.ts
var import_request_error = __toESM(require_dist_node());
var import_delay = __toESM(require_delay());
var import_core = __toESM(require_lib());

// packages/github/src/config.ts
...
var import_plugin_enterprise_server = __toESM(require_dist_node2());
...
function init_default(context, config) {
  return __async(this, null, function* () {
    ...
    if (config.checkPrLabels && import_core.Inputs.newVersion == null) {
      ...
      context.version.new = releaseType != null ? require_semver().inc(oldVersion, releaseType) : oldVersion;
    }
  });
}
...
// packages/github/src/publish.ts
var glob = __toESM(require_glob());
var import_request_error2 = __toESM(require_dist_node());
...
// packages/github/src/success.ts
...
// packages/github/src/fail.ts
var import_core4 = __toESM(require_lib());
