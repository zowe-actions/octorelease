...
function run() {
  return __async(this, null, function* () {
    ...
    try {
      ...
      try {
        yield import__.stages.init(context, pluginsLoaded);
        yield import__.utils.verifyConditions(context);
        yield import__.stages.version(context, pluginsLoaded);
        yield import__.stages.publish(context, pluginsLoaded);
        yield import__.stages.success(context, pluginsLoaded);
      } catch (error2) {
        if (error2 instanceof Error) {
          context.failError = error2;
          yield import__.stages.fail(context, pluginsLoaded);
        }
        throw error2;
      }
    } catch (error2) {
