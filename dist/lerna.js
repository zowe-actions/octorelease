...
import { DEFAULT_NPM_REGISTRY, utils as npmUtils } from "./npm";
...
// src/publish.ts
import { publish as npmPublish } from "./npm";
...
// src/success.ts
import { success as npmSuccess } from "./npm";
...
var { access, appendFile, writeFile } = promises2;
...
// src/version.ts
import { utils as npmUtils2 } from "./npm";
...
async function updateIndependentVersion(context, pkgInfo, newVersion) {
  await npmUtils2.npmVersion(newVersion, pkgInfo.location);
