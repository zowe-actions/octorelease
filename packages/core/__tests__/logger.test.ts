...
describe("Logger class", () => {
    it("should log DEBUG message to console", () => {
        vi.mocked(core.debug).mockImplementationOnce(console.debug);
    ...
    it("should log ERROR message to console", () => {
        vi.mocked(core.error).mockImplementationOnce(console.error);
    ...
    it("should log INFO message to console", () => {
        vi.mocked(core.info).mockImplementationOnce(console.info);
    ...
    it("should log WARNING message to console", () => {
        vi.mocked(core.warning).mockImplementationOnce(console.warn);
